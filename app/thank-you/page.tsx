...
export const metadata = {
  ...
  description:
    "Thank you for contacting Green Choice Excavation. We'll get back to you soon.",
};
...
export default function ThankYou() {
  return (
    <>
          ...
          __html: `
            if (typeof gtag === 'function') {
              gtag('event', 'conversion', {
                'send_to': 'AW-17696412769/QVzpCN-Z0rwbEOGop_2B'
              });
            }
          `,
        }}
      ...
      <main className="min-h-screen flex items-center justify-center bg-gradient-to-b from-green-50 to-amber-50">
