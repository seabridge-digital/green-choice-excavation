    ...
    <main className="p-6 bg-gradient-to-b from-green-50 to-amber-50 font-sans">
      ...
      <section id="home" className="relative h-[80vh] pt-20 flex items-center justify-center text-center text-white">
        ...
        <div className="relative z-10">
          <h1 className="text-6xl md:text-7xl font-bold mb-4">Green Choice Excavation</h1>
          <p className="text-2xl md:text-3xl">Professional excavation & site services</p>
          <p className="text-lg md:text-xl mt-2">Based out of Lancaster, SC — proudly serving both North and South Carolina.</p>
          <div className="mt-6 flex justify-center">
            <a href="tel:7042906688" className="bg-green-700 hover:bg-green-800 text-white px-6 py-3 rounded-lg font-semibold mr-4">Call Us</a>
            <a href="mailto:gce10@gmail.com" className="bg-white text-amber-800 hover:bg-gray-100 px-6 py-3 rounded-lg font-semibold">Email Us</a>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="mb-12">
        ...
        <div className="flex justify-center">
          <a href="tel:7042906688" className="mt-8 bg-green-700 hover:bg-green-800 text-white px-8 py-4 rounded-lg font-bold">Get a Free Quote</a>
        </div>
      </section>
      ...
      <section id="about" className="bg-white rounded-xl shadow-md overflow-hidden flex flex-col md:flex-row mb-12">
        {/* Left: Photo */}
      ...
      <section id="contact" className="mt-12 max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-md">
        ...
        <div className="bg-gradient-to-r from-green-700 to-amber-600 text-white rounded-xl shadow-md p-6 mb-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="tel:7042906688"
              className="bg-white text-green-800 hover:bg-gray-100 px-6 py-3 rounded-lg font-semibold shadow-md"
            >
              Call 704-290-6688
            </a>
            <a
              href="mailto:gce10@gmail.com"
              className="bg-white text-amber-700 hover:bg-gray-100 px-6 py-3 rounded-lg font-semibold shadow-md"
            >
